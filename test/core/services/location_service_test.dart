...
void main() {
  group('getCurrentLocation', () {
    test(
      'should return a Position when location services are enabled and permission is granted',
      () async {
    ...
    test(
      'should throw a LocationException.serviceDisabled when location services are disabled',
      () async {
        // Note: This test requires actual device permissions and location services
        // In a real test environment, you would mock Geolocator
    ...
    test(
      'should throw a LocationException.permissionDenied when permission is denied',
      () async {
        // Note: This test requires actual device permissions and location services
        // In a real test environment, you would mock Geolocator
        // For now, we'll verify the exception type exists
