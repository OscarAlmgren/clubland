...
class _ProfilePageState extends ConsumerState<ProfilePage>
  ...
  /// Maps a [UserEntity] to the [SimpleUser] display model.
  SimpleUser _toSimpleUser(UserEntity user) => SimpleUser(
    id: user.id,
  ...
  Widget build(BuildContext context) {
    ...
    final userEntity = authState.value;

    // Fall back to placeholder while loading or if unauthenticated
    final currentUser = userEntity != null
        ? _toSimpleUser(userEntity)
        : const SimpleUser(id: '', firstName: '', lastName: '', email: '');
