      ...
      ClubReviewModel(
        ...
        responses:
            (json['responses'] as List<dynamic>?)
                ?.map(
                  (response) =>
                      ReviewResponse.fromJson(response as Map<String, dynamic>),
                )
                .toList() ??
            [],
      );
...
class ReviewAspects extends Equatable {
  ...
  factory ReviewAspects.fromJson(Map<String, dynamic> json) => ReviewAspects(
...
class ReviewHelpful extends Equatable {
  const ReviewHelpful({required this.count, required this.userMarkedHelpful});

  final int count;
  final bool userMarkedHelpful;

  factory ReviewHelpful.fromJson(Map<String, dynamic> json) => ReviewHelpful(
...
class ResponseAuthor extends Equatable {
  ...
  factory ResponseAuthor.fromJson(Map<String, dynamic> json) => ResponseAuthor(
    id: json['id'] as String,
